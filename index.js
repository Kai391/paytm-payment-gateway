...
const { generateCheckSum ,verifyCheckSum} = require('./paytm/pChecksum')
...
app.post('/paynow', [parseUrl, parseJson], async(req, res) => {
    if (!req.body.amount || !req.body.email || !req.body.phone) {
        ...
        let checksum = await generateCheckSum(params);
...
app.post('/callback', (req, res) => {
    ...
    req.on('end', function () {
        ...
        // console.log(post_data['CHECKSUMHASH']);
        // delete post_data.CHECKSUMHASH;
        let result = verifyCheckSum(post_data,checksumhash);
